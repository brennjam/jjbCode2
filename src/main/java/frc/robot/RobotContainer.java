...
// The robot's subsystems
    public final FlyWheelClosedLoop m_flyWheelClosedLoop = new FlyWheelClosedLoop();
...
private final Joystick leftStick = new Joystick(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("FlyWheelClosedLoopRun: HighGoal", new FlyWheelClosedLoopRun(3000, m_flyWheelClosedLoop));
    SmartDashboard.putData("FlyWheelClosedLoopRun: LowGoal", new FlyWheelClosedLoopRun(1000, m_flyWheelClosedLoop));
    SmartDashboard.putData("FlyWheelClosedLoopRun: Reverce", new FlyWheelClosedLoopRun(-100, m_flyWheelClosedLoop));
...
final JoystickButton flyWheelReverce = new JoystickButton(leftStick, 1);        
flyWheelReverce.whileHeld(new FlyWheelClosedLoopRun(-100, m_flyWheelClosedLoop) ,true);
    SmartDashboard.putData("FlyWheelReverce",new FlyWheelClosedLoopRun(-100, m_flyWheelClosedLoop) );

final JoystickButton lowGoalClosedLoop = new JoystickButton(leftStick, 3);        
lowGoalClosedLoop.whileHeld(new FlyWheelClosedLoopRun(1000, m_flyWheelClosedLoop) ,true);
    SmartDashboard.putData("LowGoalClosedLoop",new FlyWheelClosedLoopRun(1000, m_flyWheelClosedLoop) );

final JoystickButton highGoalClosedLoop = new JoystickButton(leftStick, 2);        
highGoalClosedLoop.whileHeld(new FlyWheelClosedLoopRun(3000, m_flyWheelClosedLoop) ,true);
    SmartDashboard.putData("HighGoalClosedLoop",new FlyWheelClosedLoopRun(3000, m_flyWheelClosedLoop) );
